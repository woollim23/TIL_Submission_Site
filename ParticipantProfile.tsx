...
export default function ParticipantProfile() {
  ...
  const finesByWeek = useMemo(() => {
    ...
    for (const sub of allSubmissions.data) {
      ...
      // 2026-01-01 이전 제출은 무시
      if (subDate < cumulativeStart) continue;
    ...
    // 2) 2026-01-01이 속한 주의 월요일부터 현재까지, 주차를 순회하며 벌금 계산
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background to-muted/20 p-4 md:p-8">
      <div className="container max-w-4xl">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="p-4 bg-destructive/10 rounded-lg border border-destructive/20">
                <div className="text-sm text-muted-foreground mb-1">누적 벌금 (2026년 1월부터)</div>
        ...
        <Card className="border-0 shadow-lg mb-6">
          <CardHeader className="pb-4">
            <CardTitle className="text-2xl">주별 벌금 내역 (2026년 1월부터)</CardTitle>
